...
const MainSection = () => {
  ...
  return (
    <section className="main-section">
      ...
      <img src="./src/assets/logo.svg" alt="logo" className="main-section__logo" />
      <h1 className="main-section__title">Under Construction</h1>
      <p className="main-section__subtitle">We're making lots of improvements and will be back soon</p>
      <DateCountdown/>
    </section>
  );
};
